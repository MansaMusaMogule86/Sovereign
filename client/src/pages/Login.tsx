// ============================================================
// Login Page - SOVEREIGN
// Design: Centered glass card with neon accents, OAuth buttons
// ============================================================
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#00ff88]/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#7b2ff7]/5 rounded-full blur-[100px]" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#00d4ff]/60 font-mono text-xs">Access your quantum recovery dashboard</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full glass border border-[#00d4ff]/20 rounded-lg px-4 py-3 flex items-center gap-3 hover:border-[#00ff88]/40 transition-all text-sm font-heading"
          >
        ...
        <p className="text-center mt-6 text-xs text-[#556677] font-mono">
          ...
          <Link href="/signup"><span className="text-[#00ff88] hover:underline">Create one</span></Link>
        </p>
      </motion.div>
    </div>
  );
